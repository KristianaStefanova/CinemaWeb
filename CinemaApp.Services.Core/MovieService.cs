namespace CinemaApp.Services.Core
{
    ...
    public class MovieService : IMovieService
    {
        ...
        public async Task<bool> EditMovieAsync(MovieFormInputModel inputModel)
        {
            ...
            editableMovie.ReleaseDate = movieReleaseDate.ToDateTime(TimeOnly.MinValue);
        ...
        public async Task<MovieFormInputModel?> GetEditableMovieByAsync(string? id)
        {
        ...
        {
            MovieDetailsViewModel? editableMovie = null;
