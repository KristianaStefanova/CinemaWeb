    ...
    public partial class AddUserMovieMappingEntity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ApplicationUserId = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "Foreign key to the referenced AspNetUser. Part of the entity comosite PK."),
                    MovieId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "Foreing key to the referenced Movie. Part of the entity comosite PK."),
                ...
                comment: "User Wathlist entry in the system");
