        ...
        public List<Movie> SeedMovies()
        {
            List<Movie> movies = new List<Movie>
            {
                new Movie
                {
                    ...
                    Title = "Inception",
                    Genre = "Sci-Fi",
                    ReleaseDate = DateTime.Parse("2010-07-16T00:00:00"),
                ...
                new Movie
                {
                    ...
                    Title = "The Godfather",
                    Genre = "Crime",
                    ReleaseDate = DateTime.Parse("1972-03-24T00:00:00"),
                ...
                new Movie
                {
                    ...
                    Title = "Interstellar",
                    Genre = "Adventure",
                    ReleaseDate = DateTime.Parse("2014-11-07T00:00:00"),
                    Director = "Christopher Nolan",
                    Duration = 169,
                ...
                new Movie
                {
                    ...
                    Genre = "Action",
                    ReleaseDate = DateTime.Parse("2008-07-18T00:00:00"),
                    Director = "Christopher Nolan",
                    Duration = 152,
                ...
                new Movie
                {
                    ...
                    Title = "Pulp Fiction",
                    Genre = "Crime",
                    ReleaseDate = DateTime.Parse("1994-10-14T00:00:00"),
                ...
                new Movie
                {
                    ...
                    Title = "The Matrix",
                    Genre = "Sci-Fi",
                    ReleaseDate = DateTime.Parse("1999-03-31T00:00:00"),
                ...
                new Movie
                {
                    ...
                    Genre = "Drama",
                    ReleaseDate = DateTime.Parse("1993-12-15T00:00:00"),
                ...
                new Movie
                {
                    ...
                    Title = "Forrest Gump",
                    Genre = "Drama",
                    ReleaseDate = DateTime.Parse("1994-07-06T00:00:00"),
                ...
                new Movie
                {
                    ...
                    Genre = "Drama",
                    ReleaseDate = DateTime.Parse("1994-09-23T00:00:00"),
                ...
                new Movie
                {
                    ...
                    Title = "Avatar",
                    Genre = "Sci-Fi",
                    ReleaseDate = DateTime.Parse("2009-12-18T00:00:00"),
                ...
                new Movie
                {
                    ...
                    Title = "Gladiator",
                    Genre = "Action",
                    ReleaseDate = DateTime.Parse("2000-05-05T00:00:00"),
                ...
                new Movie
                {
                    ...
                    Title = "The Avengers",
                    Genre = "Action",
                    ReleaseDate = DateTime.Parse("2012-05-04T00:00:00"),
                ...
                new Movie
                {
                    ...
                    Title = "The Lion King",
                    Genre = "Animation",
                    ReleaseDate = DateTime.Parse("1994-06-15T00:00:00"),
                ...
                new Movie
                {
                    ...
                    Title = "Jurassic Park",
                    Genre = "Adventure",
                    ReleaseDate = DateTime.Parse("1993-06-11T00:00:00"),
                    Director = "Steven Spielberg",
                    Duration = 127,
                ...
                new Movie
                {
                    ...
                    Genre = "Thriller",
                    ReleaseDate = DateTime.Parse("1991-02-14T00:00:00"),
                ...
                new Movie
                {
                    ...
                    Genre = "Drama",
                    ReleaseDate = DateTime.Parse("1999-12-10T00:00:00"),
                    Director = "Frank Darabont",
                    Duration = 189,
                ...
                new Movie
                {
                    ...
                    Title = "Fight Club",
                    Genre = "Drama",
                    ReleaseDate = DateTime.Parse("1999-10-15T00:00:00"),
                ...
                new Movie
                {
                    ...
                    Genre = "Western",
                    ReleaseDate = DateTime.Parse("2012-12-25T00:00:00"),
                    Director = "Quentin Tarantino",
                    Duration = 165,
